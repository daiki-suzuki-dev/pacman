...
# Load config
PER_PAGE = int(os.getenv("PER_PAGE", 2))
    ...
    return [
        {
            ...
            "first_name": "John",
            "last_name": "Doe",
            "email": f"john{base_id+1}@test.com",
            "notes": "Strong Python dev",
            "tags": ["Python", "Backend"],
            "resume_url": None
        },
        {
            ...
            "first_name": "Jane",
            "last_name": "Smith",
            "email": f"jane{base_id+2}@test.com",
            "notes": "",
            "tags": [],
            "resume_url": None
        }
...
# --------------------------------test-------------
def create_candidate_ashby(candidate):
    # Simulate Ashby ID creation
    return f"ashby_{candidate['email']}"

def upload_resume_ashby(ashby_id, resume_file):
    return True  # always success for test
